...
public class LogoutAccountant extends HttpServlet {
	protected void doGet(HttpServletRequest req, HttpServletResponse rs) throws ServletException, IOException {
		...
		req.getRequestDispatcher("navhome.html").include(req, rs);
		
		
		pw.println("<div class='row'><div class='col-2'></div><div class='col-10'><br><b style='color:blue;font-size:30px;'>Accountant Logout Success <span class='bi bi-check-circle-fill'></span></b></div></div>");
