...
public class AccountantLogin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse rs) throws ServletException, IOException {
		...
		pw.println("<html>");
		pw.println("<head>");
		pw.println("<title>Accountant Panel</title>");
		...
		if(status){
			...
			pw.println("<br>");
			req.getRequestDispatcher("accountanthome.html").include(req, rs);
			pw.println("<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>");
