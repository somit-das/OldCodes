...
//		}
	...
	public ResponseStructure<List<Person>> findUserByNameController(@RequestParam String name){ //java.lang.IllegalStateException: Ambiguous handler methods mapped for '/persons/smith': {public org.jsp.thirteen_boot.responsestructure.ResponseStructure org.jsp.thirteen_boot.controller.PersonController.findUserByNameIdController(int), public org.jsp.thirteen_boot.responsestructure.ResponseStructure org.jsp.thirteen_boot.controller.PersonController.findUserByIdController(int)}

		return service.findUserByNameService(name);
	}
