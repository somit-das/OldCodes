...
//	postmap /events 
	@PostMapping("/events")
	public ResponseStructure<Event> saveEvent(
...
//		Event event = new Event(0, title, place,date, status);
		Event event = new Event(0, title, place, LocalDate.parse(date), status);
